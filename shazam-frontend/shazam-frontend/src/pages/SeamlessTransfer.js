                ...
                <div className="content">
                    ...
                    {uploadState !== 'success' ? (
                        ...
                        <div className="success-screen">
                            ...
                            <h2 className="success-title">Files Ready!</h2>
                            <p className="success-text">Scan the QR code or copy the link to download your files.</p>
                            ...
                            <div className="url-container">
                                <p className="download-url">{downloadUrl}</p>
                                <button onClick={copyToClipboard} className="copy-button" title="Copy link">
                                    <Link size={20} />
                                </button>
                            </div>
                            <p className="expiry-notice">Link will expire in 24 hours (or after first download).</p>
                        </div>
                    )}
...
export default SeamlessTransfer;